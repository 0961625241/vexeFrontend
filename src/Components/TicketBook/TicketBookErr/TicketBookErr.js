...
export default class Ticketbookerr extends Component {

    render() {
        let seats1c= [1, 2, 3, 4, 5, 6];
        let seats2c= [1, 2, 3, 4, 5, 6]
                  ...
                  <div className="col-md-5">
                      <div className="info-container">
                          ...
                          <div className="alert alert-info">  <div className="LoadSpinErr" >
                              <Spin className='SpinErr' />
                              <div>Đang tìm thông tin chuyến</div>
                          </div></div>
                          ...
                          <div className="alert alert-info">  <div className="LoadSpinErr" >
                              <Spin className='SpinErr' />
                              <div>Đang tìm địa điểm lên xe</div>
                          </div></div>
                      </div>
                  </div>
